...
const users = [
	{ username: "anna", email: "anna", password: "anna" },
	...
	render() {
		return (
			<View style={styles.container}>
				<Image style={styles.logo} source={koala} />

				<View style={styles.fieldContainer}>
					<Image style={styles.icon} source={atSymbol} />
					<TextInput
						style={{ height: 40 }}
						placeholder="Email"
				...
				<Text style={styles.link} onPress={this._forgottenPasword}>
					Forgot my password
				</Text>
				<Text style={styles.link} onPress={this._signUp}>
					Sign up
				</Text>
			</View>
		);
